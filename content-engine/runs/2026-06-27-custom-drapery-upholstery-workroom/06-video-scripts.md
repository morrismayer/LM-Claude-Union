...
## Script 1 — Pattern repeat

[ON CAMERA]
"A designer hands me a spec sheet, and I can tell a lot just from what's
missing — not the fabric choice, that part's usually right. It's whether
anyone checked the pattern repeat against the yardage.

[B-ROLL: hand unrolling a large-pattern fabric across a cutting table]

A big repeat needs extra fabric so the motif lines up panel to panel. Skip
that, and you get a mismatch that's invisible on a swatch and impossible to
...
## Script 2 — Trim is three decisions
...
## Script 3 — Fullness ratio

[ON CAMERA]
"Fabric is what a client falls in love with. Hardware's what they call us
about three years later — and the most under-specified number on most jobs
is fullness ratio.

[B-ROLL: ripplefold drapery panel sliding open along a track]

That's how much fabric width you're using relative to the finished rod or
